## Score TCGA LUAD patients via Average pathway Hellinger distances
...
load(file = "~/Dropbox/Splice-n-of-1-pathways/Data/luad_iso_kegg_data.RData") ## NEW ISOFORM 25 Jul 2017
...
for (tmp_pat in patients_chr) {
    ...
    iso_kegg_list[[tmp_pat]] <- (data.frame(geneSymbol = luad_iso_kegg_data$geneSymbol,
                                            luad_iso_kegg_data[, grep(tmp_pat, names(luad_iso_kegg_data))]))
    iso_kegg_list[[tmp_pat]][, "geneSymbol"] <- as.character(luad_iso_kegg_data$geneSymbol)
}
...
## 
## ## save the object
## save(scores_list, file = "~/Dropbox/Splice-n-of-1-pathways/Data/TCGA_LUAD_hel_avg_Iso30_expressiod_pathwayfilter_KEGG_25july2017.RData")
...
## save the object
save(scores_list, file = "~/Dropbox/Splice-n-of-1-pathways/Data/TCGA_LUAD_hel_EE_Iso30_expressiod_pathwayfilter_KEGG_25july2017.RData")
