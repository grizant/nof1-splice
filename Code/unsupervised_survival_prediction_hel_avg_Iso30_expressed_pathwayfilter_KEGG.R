...
load(file = "~/Dropbox/Splice-n-of-1-pathways/Data/TCGA_BRCA_hel_avg_Iso30_expressiod_pathwayfilter_KEGG_18july2017.RData")
...
table(missing_logic) ## only 39 pathways to remove
...
# COX PH
sf1_coxph = coxph(clin_surv ~ as.factor(cluster), data = clin_data)
