## Validate TCGA LUSC patients via Average pathway Hellinger distances
...
target_data <- get_target_info(scores_list, target = target, cancer_ids = cancer_ids, fdr = 0.1, one_sided = T)
