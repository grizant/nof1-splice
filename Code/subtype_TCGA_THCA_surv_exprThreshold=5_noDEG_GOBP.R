## THCA subtyping via Splice-N-of-1-pathways on GOBP pathways
## AG Schissler
## Created 10 Aug 2018
...
load(file = "~/Dropbox/Splice-n-of-1-pathways/Data/TCGA_THCA_hel_EE_Iso30_exprThreshold=5_NoDEG_GOBP_9aug2018.RData")
