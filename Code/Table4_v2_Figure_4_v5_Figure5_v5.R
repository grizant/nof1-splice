...
## save for Fig 2
save(rand_pvalue, file = "~/Dropbox/splice-n-of-1-pathways/Data/Figure2_emp_pvalue.RData")
...
saveRDS(emp_pvalue, "~/Dropbox/Splice-n-of-1-pathways/Data/N1PAS_surv_empirical_pvalues.RDS")

######################################################
## explore top hits
emp_pvalue <- readRDS("~/Dropbox/Splice-n-of-1-pathways/Data/N1PAS_surv_empirical_pvalues.RDS")
...
save_plot("N1PAS_Target_pathway_surv.pdf", s4)
