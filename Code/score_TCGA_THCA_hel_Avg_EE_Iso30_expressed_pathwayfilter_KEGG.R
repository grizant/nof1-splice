...
patients_chr <- unique(substring(names(thca_iso_kegg_data[,-(1:4)]), 1, 12))
...
## 
## ## save the object
## save(scores_list, file = "~/Dropbox/Splice-n-of-1-pathways/Data/TCGA_THCA_hel_avg_Iso30_expressiod_pathwayfilter_KEGG_25july2017.RData")

## now score by Empirical Enrichment
system.time(scores_list <- parallel::parLapply(cl = cl, iso_kegg_list, transform_iso_pathway, annot_file = "~/Dropbox/Lab-Tools/GeneSets/KEGG/kegg_tb.txt", desc_file = "~/Dropbox/Lab-Tools/GeneSets/KEGG/kegg.description_tb.txt", pathway_method = "EE", gene_method = "hellinger")) ## 17 seconds

## save the object
save(scores_list, file = "~/Dropbox/Splice-n-of-1-pathways/Data/TCGA_THCA_hel_EE_Iso30_expressiod_pathwayfilter_KEGG_25july2017.RData")
