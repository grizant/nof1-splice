## COAD subtyping via Splice-N-of-1-pathways
## AG Schissler
## Created 27 Jul 2017
...
load(file = "~/Dropbox/Splice-n-of-1-pathways/Data/TCGA_COAD_paired_clinical.RData")
load(file = "~/Dropbox/Splice-n-of-1-pathways/Data/TCGA_COAD_hel_EE_Iso30_expressiod_pathwayfilter_KEGG_25july2017.RData")
