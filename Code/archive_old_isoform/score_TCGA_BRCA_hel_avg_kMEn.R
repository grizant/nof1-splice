...
## but now filter non-expressed isoforms
## AG Schissler
## Created 11 Jul 2017
...
## 
## system.time(avg_scores <- parallel::parLapply(cl = cl, tmp_list, transform_iso_pathway,
##                                   annot_file = "~/Dropbox/Lab-Tools/GeneSets/GO/2015/go_bp_filtered15-500.txt"
## , desc_file = "~/Dropbox/Lab-Tools/GeneSets/GO/2015/go_bp_description.txt",
## pathway_method = "avg", gene_method = "hellinger"))
## 

##############################################################################
#### 4. Score all patients

system.time(scores_list <- parallel::parLapply(cl = cl, iso_go_list, transform_iso_pathway, annot_file = "~/Dropbox/Lab-Tools/GeneSets/GO/2015/go_bp_filtered15-500.txt", desc_file = "~/Dropbox/Lab-Tools/GeneSets/GO/2015/go_bp_description.txt", pathway_method = "avg", gene_method = "hellinger")) ## 390 seconds

## save the object
save(scores_list, file = "~/Dropbox/Splice-n-of-1-pathways/Data/TCGA_BRCA_hel_avg_14apr2017.RData")

##############################################################################
#### 5. Explore

num_hits <- unlist(lapply(scores_list, function(tmp_data){
    sum(tmp_data$diff_splice_call)
}))
