## BRCA subtyping via Splice-N-of-1-pathways
## AG Schissler
## Created 27 Jul 2017
...
fdr_hits <- names(transformed_pvalue[transformed_pvalue < tmp_locfdr$z.2[1]])
tmp_data[fdr_hits,]
fil_effect_mat[,fdr_hits]
