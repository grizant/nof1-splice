## Store TCGA LUSC TPM as RData for convenience and computational efficiency
## subset to only genes in filtered KEGG-BP 2015
## AG Schissler
## Created 25 Jul 2017

################################
## 1. Create environment and lusc in counts
setwd("~/Dropbox/Splice-n-of-1-pathways")

load("Data/lusc_iso_paired_tpm.RData")
...
lusc_iso_kegg_data <- lusc_iso[lusc_iso$geneSymbol %in% kegg_genes,]
nrow(lusc_iso_kegg_data)
nrow(lusc_iso)
...
save(lusc_iso_kegg_data, file = "~/Dropbox/Splice-n-of-1-pathways/Data/lusc_iso_kegg_data.RData")
